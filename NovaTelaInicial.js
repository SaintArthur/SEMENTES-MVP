  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topCirclesContainer}> 
          ...
          <View style={[styles.circleBase, styles.centralCircle, { backgroundColor: GREEN_MEDIUM, left: width * 0.20, top: -30, width: width * 0.7, height: width * 0.7 }]} />
      </View>
      ...
      <View style={styles.bottomCirclesContainer}>
          ...
          {/* Círculo central (mais claro e por cima) */}
          <View style={[styles.circleBase, styles.centralCircle, { backgroundColor: GREEN_MEDIUM, left: width * 0.20, bottom: -30, width: width * 0.7, height: width * 0.7 }]} />
      </View>
    </View>
  );
}
